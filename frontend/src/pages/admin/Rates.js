  ...
  return (
    <div className="space-y-6">
      ...
      <Card title="Enter Rate (per tola)">
        <form onSubmit={submit} className="grid grid-cols-1 sm:grid-cols-5 gap-3 items-end" data-testid="rates-admin-form">
          ...
          <F label="Gold 24K"><input className={inp} type="number" step="any" value={form.gold_24k} onChange={(e) => setForm({ ...form, gold_24k: e.target.value })} data-testid="rates-gold24-input" /></F>
          <F label="Gold 22K"><input className={inp} type="number" step="any" value={form.gold_22k} onChange={(e) => setForm({ ...form, gold_22k: e.target.value })} data-testid="rates-gold22-input" /></F>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead><tr className="text-left text-xs text-slate-500 border-b">
              <th className="py-2">Date AD</th><th>Date BS</th><th>Gold 24K</th><th>Gold 22K</th><th>Silver</th></tr></thead>
