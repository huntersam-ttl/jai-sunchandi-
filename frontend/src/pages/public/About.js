...
export default function About() {
  ...
  useDocumentMeta(
    `About Us – ${PUBLIC_BRAND_NAME}`,
    "A family-run gold and silver jewellery shop in Nepal, trusted for transparent weight, clear jarti and jyala, and fair old gold exchange."
  );
  return (
    <div className="brand-shell max-w-5xl py-12 sm:py-16">
      ...
      <p className="font-devanagari text-[#5B0D18] mt-4">{shop.shop_name_np} · {shop.tagline_np}</p>
      <Reveal className="mt-10 grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-4 text-[#5F5147] leading-relaxed">
          <p><b>{PUBLIC_BRAND_NAME}</b> is the public brand of <b>{OFFICIAL_SHOP_NAME}</b>, a family-run gold and silver shop that has served its community for decades. Families visit us for weddings, festivals and everyday ornaments.</p>
